...
public class TabLayout
{
    ...
    public void forceSet(final int pos, final String name) {
    ...
    public void setHeader(final String header) {
        this.header = ComponentSerializer.toString((BaseComponent)new TextComponent(ChatColor.translateAlternateColorCodes('&', header)));
    }
    
    public void setFooter(final String footer) {
        this.footer = ComponentSerializer.toString((BaseComponent)new TextComponent(ChatColor.translateAlternateColorCodes('&', footer)));
    }
